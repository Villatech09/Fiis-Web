					...
					<div class="row double">
						...
						<div class="8u">
							<div id="content">
								...
								<header>
								<a name="arriba"><h2>Maestrias en Ingenieria Industrial</h2><a>
								</header>
								<p style="color:black">Maestria con mencion en:</p>
									<a href="#calidad" style="color:black">Gerencia de la calidad y productividad</a><br></br>
    								<a href="#logistica" style="color:black">Gerencia en logistica</a><br></br>
    								<a href="#productividad" style="color:black">Productividad y relaciones industriales</a><br></br>
...
<h3><a name="calidad">MAESTRIAS EN INGENIERIA INDUSTRIAL CON MENCION EN: GERENCIA DE LA CALIDAD Y PRODUCTIVIDAD</a></h3><br></br>
