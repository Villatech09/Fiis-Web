...
<html>
	...
	<body>
		...
		<?php
			...
			elseif (($archivoActual == 'pregrado-epii.php') or ($archivoActual == 'pregrado-epis.php') or ($archivoActual == 'pregrado-epii-perfil.php')or ($archivoActual == 'pregrado-epis-perfil.php') or ($archivoActual == 'pregrado-epis-malla.php')) {
		 		# code...
		 		headerWebPregrado();
		 	}	
