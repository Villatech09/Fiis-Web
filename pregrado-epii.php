			...
			<section class="wrapper style1">
				<div class="container">
					<div class="row">
						...
						<section class="6u">
							<div class="box post">
								<a href="pregrado-epii-plan.php" class="image left"><img src="images/plan-industrial.jpg" alt="" /></a>
								<div class="inner">
					...
					<div class="row">
						<section class="6u">
							<div class="box post">
								<a href="pregrado-epii-plana.php" class="image left"><img src="images/pic02.jpg" alt="" /></a>
								<div class="inner">
									<h3>Plana docente</h3>
						...
						<section class="6u">
							<div class="box post">
								<a href="pregrado-epii-malla.php" class="image left"><img src="images/pic03.jpg" alt="" /></a>
								<div class="inner">
					...
					<div class="row">
						<section class="6u">
							<div class="box post">
								<a href="pregrado-epii-autoridades.php" class="image left"><img src="images/pic04.jpg" alt="" /></a>
								<div class="inner">
									<h3>Autoridades</h3>
									<p>encargados de...</p>
								</div>
