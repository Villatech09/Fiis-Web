	...
	<section class="wrapper style1">
				<div class="container">
					<div class="row">
						...
						<section class="6u">
							<div class="box post">
								<a href="postgrado-epii-planestudios.php" class="image left"><img src="images/pic01.jpg" alt="" /></a>
								<div class="inner">
									<h3>Maestrias en Ingenieria Industrial</h3>
								<dl>
									<dt>Maestria con mencion en:</dt> 
									<dd>Gerencia de la calidad y productividad</dd>
									<dd>Gerencia en logistica</dd> 
									<dd>Productividad y relaciones industriales</dd>
								</dl>
								<br></br>
								<a href="postgrado-epii-planestudios.php" class="button">Leer más</a>
						...
						<section class="6u">
							<div class="box post">
								<a href="postgrado-epis-planestudios.php" class="image left"><img src="images/pic02.jpg" alt="" /></a>
								<div class="inner">

									<h3>Maestria en Ingenieria de Sistemas</h3>
									<br></br>
<br></br>
<br></br>
									<a href="postgrado-epis-planestudios.php" class="button">Leer más</a>
								</div>
							</div>
						</section>
					</div>
