					...
					<div class="row double">
						<section class="6u">
							<div class="box highlight">
								...
								<h3>Misión</h3>
								<p>La Facultad de Ingeniería Industrial y de Sistemas forma profesionales en Ingeniería Industrial e Ingeniería de Sistemas 
						...
						<section class="6u">
							<div class="box highlight">
								...
								<h3>Visión</h3>
								<p>Ser una Facultad acreditada y con liderazgo a nivel nacional e internacional, gestora del conocimiento, formadora de profesionales 
